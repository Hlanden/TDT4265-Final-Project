...
def main():
    ...
    for loader_name, loader in loaders.items():
        ...
        total_img = 0
        with torch.no_grad():
            for num_batches, (images, targets, shapes, padding, org_targets) in enumerate(tqdm(loader)):
                ...
                dice_score = dice_score_multiclass(outputs, targets, len(cfg.MODEL.CLASSES),shapes=shapes, padding=padding, org_targets=org_targets).flatten()
